...
<html>
	...
	#nav-menu nav ul li a{display: block; padding:10px 10px; color: green;transition: all 0.3s linear;}
	#nav-menu nav ul li a:hover, #nav-menu nav ul li.current_page_item > a{color: #fff;background: linear-gradient(#09f7d7, #124706);border-radius: 10px;}
	...
	/* ASIDE RIGHT CONFIG */
	#aside-right {width:250px; height:auto; background:white; border-radius: 10px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);}
	...
	/* FOOTER CONFIG */
	footer { padding: 5px 0; clear:both;text-align:center;height:50px; background:red; color:#fff;}
